...
export default {
    ...
    methods: {
        async Register() {
            ...
            const res = await fetch(`${import.meta.env.VITE_APP_BACKEND_URL}/users/register`, req);
...
<template>
  <main>
    <div class="main">
      <div class="form">
        <div>
          <div class="field"><input type="text" placeholder="email" v-model="email"></div>
          ...
          <div class="field"><div class="button" @click="Register">Login</div></div>
        </div>
      </div>
    </div>
  </main>
